package ir.mosi.airline.reservation.system.exception.global;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(value = {AirplaneNotFoundException.class, PassengerNotFoundException.class})
    ...
    @ExceptionHandler(value = {DuplicateAirplaneException.class, DuplicatePassengerException.class})
